...
public interface EvatListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EvatParser#tagAttributeValue}.
	 * @param ctx the parse tree
	 */
	void enterTagAttributeValue(EvatParser.TagAttributeValueContext ctx);
	/**
	 * Exit a parse tree produced by {@link EvatParser#tagAttributeValue}.
	 * @param ctx the parse tree
	 */
	void exitTagAttributeValue(EvatParser.TagAttributeValueContext ctx);
	/**
